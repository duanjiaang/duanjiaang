...
let tools = {
  ...
  formatDate(date, format) {
    ...
    console.log('类型判断：', typeof date, date instanceof Date, date instanceof Number);
  ...
  // ajax请求封装过程
  ajax() {
    // arguments是function内置对象，表示调用function传入的参数
    ...
    // 1：单一参数，必须是json，格式为{url:'',params:{},callback,method}
    // 2：三个参数就是url，params，callback
    // 4：四个参数就是url，params，callback,method
